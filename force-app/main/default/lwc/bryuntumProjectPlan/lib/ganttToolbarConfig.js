...
import handleDml from '@salesforce/apex/ProjectGanttBryntumHelper.saveData';

export default base => class GanttToolbarConfig extends base {
    static get $name() {
        return 'GanttToolbar';
    }
                    ...
                    items : [
                        {
                            ...
                            color    : 'b-green',
                            ref      : 'addTaskButton',
                            icon     : 'b-fa b-fa-floppy-disk',
                            text     : 'Save',
                            disabled : false,
                            tooltip  : 'Save Project Changes',
                            onAction : 'up.onSaveProject'
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    items : [
                        ...
                        },
                        {
                            type        : 'button',
                            color       : 'b-blue',
                            icon        : 'b-fa-pen-to-square',
                            text        : 'Disable Editing',
                            toggleable  : true,
                            tooltip     : 'Enable/ Disable Editing',
                            onAction    : 'up.onDisableEditing'
                        }
                    ]
                },
                {
    ...
    onSaveProject(){
        let changeData = JSON.stringify(this.gantt.project.changes);
        if(changeData){
            handleDml({jsonData : changeData}).then(result=>{
    ...
    onDisableEditing({source}) {
        ...
        console.log("Under on disable editing function");
        this.gantt.feature.dependencies.allowCreate = !source.pressed;
        this.gantt.feature.percentBar.allowResize = !source.pressed;
        this.gantt.feature.cellEdit = !source.pressed;
        this.gantt.feature.taskEdit = !source.pressed;
        this.gantt.feature.taskMenu = !source.pressed;
        this.gantt.feature.taskdrag = !source.pressed;
        this.gantt.feature.taskResize = !source.pressed;
        this.gantt.feature.taskDragCreate = !source.pressed;
    }
};